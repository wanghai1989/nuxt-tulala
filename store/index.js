...
pageSize:10,  //每页条数
  ...
  coupons:[],//满减券列表
  hotWord:{
    'png':['春天','疫情',' 简历',' 谷雨',' 工作总结',' 开学第一课',' 边框',' 片头',' 培训'],
    'bjtp':['虎年','科技','红色','3D立体','新年','商务','医疗','酸性风','年货节','年会'],
    'ui':['ui','虎年','科技','红色','3D立体','新年','商务','医疗','酸性风','年货节','年会'],
    'mbsc':['模板','虎年','科技','红色','3D立体','新年','商务','医疗','酸性风','年货节','年会'],
    'syt':['摄影图','虎年','科技','红色','3D立体','新年','商务','医疗','酸性风','年货节','年会'],
    'word':['word','虎年','科技','红色','3D立体','新年','商务','医疗','酸性风','年货节','年会'],
    'ppt':['ppt','虎年','科技','红色','3D立体','新年','商务','医疗','酸性风','年货节','年会'],
    'excel':['excel','虎年','科技','红色','3D立体','新年','商务','医疗','酸性风','年货节','年会']
  },
  designlevel:{1:'设计助理',2:'设计师',3:'资深设计师',4:'设计指导'},
  publicStateName:{0:'待审核',1:'安全雇佣',2:'审核拒绝',3:'待确认',4:'支付定金',5:'支付尾款',6:'已完成',7:'已过期',8:'已结算'},  //我的发布状态名
