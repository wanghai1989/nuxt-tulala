...
<div class="about-contain">
			<div class="cert-item mt30">
				...
				<router-link to="/mine/basic-info"  class="btn-cert">{{personInfo.is_complete_my_info?'查看':'去完善'}}</router-link>
			...
			<div class="cert-item">
				...
				<router-link to="/mine/mobile-bind"  class="btn-cert" v-else>去认证</router-link>
			...
			<div class="cert-item">
				...
				<router-link to="/mine/real-name"  class="btn-cert"  v-else>{{personInfo.certification==3?'重新认证':'去认证'}}</router-link>
